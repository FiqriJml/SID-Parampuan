                        ...
                        <div class="ibox-content">
                            <form action="tambah_proses.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="jabatan_sekdes" class="form-control">
                                    </div> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="kasi_pemerintahan" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="kasi_kesejahteraan" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
