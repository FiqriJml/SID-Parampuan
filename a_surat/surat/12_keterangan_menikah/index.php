...
$judul_surat = "Surat Keterangan Menikah";
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<form action="surat.php" target="_blank" method="GET" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Nik Suami</label>
										<div class="col-sm-5">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Nik Istri</label>
										<div class="col-sm-5">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Menikah di </label>
										<div class="col-sm-5">
	...
	<script type="text/javascript">
		...
		var vm = new Vue({
			...
			data: {
				...
				keterangan: 'Dusun Pegilen pada tahun 2015',
				nik_bapak: '',
				nik_ibu: '',
