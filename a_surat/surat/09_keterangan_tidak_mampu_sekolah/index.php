						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<form action="surat.php" target="_blank" method="GET" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Nik Orang Tua</label>
										<div class="col-sm-5">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Nik Anak</label>
										<div class="col-sm-5">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Nama Sekolah/Kampus</label>
										<div class="col-sm-5">
											<input type="text" name="nama_sekolah" class="form-control" v-model="nama_sekolah">
										</div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript">
		...
		var vm = new Vue({
			...
			data: {
				...
				data_bapak: '',
				nama_sekolah: 'SMKN 5 MATARAM, KELAS: X',
