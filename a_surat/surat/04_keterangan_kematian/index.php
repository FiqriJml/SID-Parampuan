...
<body>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>Membuat Surat Keterangan Kematian</h5>
							</div>
							<div class="ibox-content">
								...
								<form action="surat.php" target="_blank" method="GET" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Meninggal Pada</label>
										<div class="col-sm-5">
											<input type="text" name="meninggal_pada" class="form-control" 
											v-model="meninggal_pada">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Meninggal Di</label>
										<div class="col-sm-5">
											<input type="text" name="meninggal_di" class="form-control" 
											v-model="meninggal_di">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Meninggal Karena</label>
										<div class="col-sm-5">
											<input type="text" name="meninggal_karena" class="form-control" 
											v-model="meninggal_karena">
										</div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript">
		...
		var vm = new Vue({
			el: '#app',
			data: {
				meninggal_pada: 'Bulan November tahun 2016',
				meninggal_di: 'Rumah Kediamannya',
				meninggal_karena: 'Sakit',
				data_desa: data_desa,
				opsi_ttd: [
