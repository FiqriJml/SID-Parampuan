...
$jenis_kelamin_anak = $_GET['jenis_kelamin_anak'];
$ttl_anak = $_GET['ttl_anak'];
        ...
        <div class="surat">
            <div class="surat-isi">
                ...
                <div class="surat-badan">
                    ...
                    <div class="text-justify">
                        ...
                        <div class="tabel">
                            <table border="0">
                                ...
                                <tr>
                                    <td></td>
                                    <td>Warganegara</td> <td>:</td> <td>WNI</td>
                                </tr>
                                <tr>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-justify" valign="top">Dusun <?= $data_bapak['dusun']; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td valign="top">Alamat</td> <td valign="top">:</td> 
                                    <td class="text-justify" valign="top">Dusun <?= $data_penduduk['dusun']; ?></td>
                                </tr>
                            </table>
                        </div>  
                        <br>
                        <p>&emsp;&emsp;&emsp;Bahwa yang namanya tersebut diatas memang benar penduduk yang
                            berdomisili di wilayah kami dan sepengetahuan kami pasangan tersebut di atas
                            adalah suami isteri dan mempunyai anak sebagai berikut :</p>

                        <p>Atas pernikahan yang sah lahir anak-anak:</p>
                    ...
                    <p>
                        &emsp;&emsp;&emsp;Demikian surat keterangan ini kami buat dengan sebenarnya untuk dapat
