...
$judul_surat = "Surat Keterangan Harga Tanah";
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<form action="surat.php" target="_blank" method="GET" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Keterangan <br>Harga Tanah</label>
										<div class="col-sm-5">
											<textarea rows="4" type="text" name="keterangan" class="form-control" v-model="keterangan"></textarea>
										</div>
									</div>
	...
	<script type="text/javascript">
		...
		var vm = new Vue({
			...
			data: {
				...
				penghasilan_ortu: 'rata-rata Rp. 900.000,- /bulan',
				keperluan: 'Bekerja',
				keterangan: 'Jalan TGH Lopan Labuapi Desa Perampuan Kecamatan Labuapi Kabupaten Lombok Barat berkisar antara Rp. 50.000.000.- sampai dengan Rp. 75.000.000.-',
