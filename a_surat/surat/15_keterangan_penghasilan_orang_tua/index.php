...
$judul_surat = "Surat Keterangan Penghasilan Orang Tua";
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<form action="surat.php" target="_blank" method="GET" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Penghasilan Orang Tua</label>
										<div class="col-sm-5">
											<input type="text" name="penghasilan_ortu" class="form-control" v-model="penghasilan_ortu">
										</div>
									</div>
