...
$jenis_surat = 'Surat Keterangan Tidak Mampu / Miskin';
                ...
                <div class="surat-badan">
                    ...
                    <div class="text-justify">
                        ...
                        <div class="tabel">
                            <table>
                                <tr>
                                    <td class="label-td">Nama</td> <td>:&emsp;</td> <td><?= $_GET['dusun_kadus']; ?></td>
                                </tr>
                                <tr>
                                    <td>Jabatan</td> <td>:</td> <td>Kepala Dusun <?= ucwords(strtolower($_GET['dusun_nama']))?></td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <p>&emsp;&emsp;&emsp;&emsp;Bahwa yang namanya tersebut diatas memang benar penduduk yang berdomisili di wilayah kami dan
                            sepengetahuan dan penyelidikan kami memang benar keadaan ekonominya tidak mampu ( Miskin ), sehingga
                            tidak mampu untuk menanggung biaya <?= $keterangan; ?>.
                        </p>
                        <p>&emsp;&emsp;&emsp;&emsp;Demikian surat keterangan ini kami buat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</p>
                    </div> 
                    <br>
                    <table border="0">
                        <tr>
                            <td width="20px"></td>
                            <td width="" class="text-center" valign="top">
                                Regno : ...................... <br>
                                Tanggal :...........................<br>
                                Mengetahui <br>
                                <?php 
                            ...
                            <td class="text-center" valign="top">
                                ...
                                Kepala Dusun <?= ucwords(strtolower($_GET['dusun_nama']))?>, <br><br><br> <br> <br> <br><br>
                            </td>
                        </tr>
                        <tr>
                            <td width="20px"></td>
                    ...
                    <table border="0">
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                Regno : ...................... <br>
                                Tanggal :...........................<br>
                                CAMAT LABUAPI,<br><br> <br> <br><br>

                                <b><u><?= $_GET['nama_camat']?></u></b>
                            </td>
                            <td width="220px"></td>
                        </tr>
                    </table>
