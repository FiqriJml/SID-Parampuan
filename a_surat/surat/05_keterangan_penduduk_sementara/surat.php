            ...
            <div class="surat-isi">
                ...
                <div class="surat-badan">
                    <div class="text-center">
                        <span class="garis_bawah"><b>SURAT KETERANGAN PENDUDUK SEMENTARA</b></span> <br>
                        <div style="margin-top: 3px;">
                        Nomor: 470 / <?= $no_agenda; ?> / PEM-LA / 2019<br>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="tabel">
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        if(strtolower($data_penduduk['kewarganegaraan']) == 'indo') 
                                            echo "Indonesia"; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">Alamat E-KTP</td> <td valign="top">:</td> 
                                    <td class="text-justify" valign="top"><?= $alamat; ?> </td>
                                </tr>
                            </table>
                        </div>  
                        <br>
                        <p>&emsp;&emsp;&emsp;Bahwa yang namanya tersebut di atas sepengetahuan serta pendataan kami hingga surat
                            keterangan ini ditandatangani adalah memang benar terdata sebagai Penduduk Sementara di
                            wilayah kami di <b><?= $tempat_tinggal; ?></b>. <br>
