...
<body>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-8">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<strong>Surat Keterangan Penduduk Sementara</strong>
						</li>
					</ol>
				</div>
			</div>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>Membuat Surat Keterangan Penduduk Sementara</h5>
							</div>
							<div class="ibox-content">
								...
								<form action="surat.php" target="_blank" method="GET" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Tempat Tinggal</label>
										<div class="col-sm-5">
											<textarea type="text" name="tempat_tinggal" class="form-control" 
											v-model="tempat_tinggal" rows="4">></textarea>
										</div>
									</div>
									<div class="form-group">
	...
	<script type="text/javascript">
		...
		var vm = new Vue({
			el: '#app',
			data: {
				tempat_tinggal: 'Komplek Perumahan ROYAL ZAM-ZAM 2 Blok. F No. 12 RT.16 Dusun Labuapi Utara Desa Labuapi Kecamatan Labuapi Kab. Lombok Barat',
				keterangan: 'Surat Keterangan Penduduk Sementara ini berlaku selama 1 bulan dari tanggal diterbitkan',
