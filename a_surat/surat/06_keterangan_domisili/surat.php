            ...
            <div class="surat-isi">
                ...
                <div class="surat-badan">
                    <div class="text-center">
                        ...
                        Nomor: 470 / <?= $no_agenda; ?> / <?= $no_label; ?> / 2019<br>
                        </div>
                    </div>
                    <br>
                    <div class="text-justify">
                        ...
                        <br>
                        <p>&emsp;&emsp;&emsp;Bahwa orang yang namanya tersebut diatas sepengetahuan dan penyelidikan kami memang
                            benar berdomisili di Wilayah Dusun <?= $data_penduduk['dusun']; ?> Desa <?= $data_penduduk['desa']; ?> Kecamatan <?= $data_penduduk['kecamatan']; ?> Kabupaten Lombok Barat dan <?= $keterangan; ?>. 
